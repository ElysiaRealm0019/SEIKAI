...
| 文件 | 用途 |
|------|------|
| `MMDToonShader_SM5_SingleFunc.hlsl` | **主文件**——直接粘贴到 Custom 节点 Code 字段，本 README 后续内容均针对此文件 |
...
> 完整管线与闪烁修复见 `Latest_Development/Documentation/MMDToonShader_Full_AI_使用文档.md`。
>
